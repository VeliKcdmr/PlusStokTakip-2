...
namespace PlusStokTakip.PresentationLayer.Admin.Modules.Tanimlar
{
    public partial class FrmModel : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            var modelsList = _modelsManager.TGetAll().Select(m => new
            {
                m.ModelID,
                m.ModelName,
                m.ModelYear,
        ...
        {
            var brands = _brandManager.TGetAll().Select(b => new
            {
                b.BrandID,
                b.BrandName
            }).ToList();
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (selectedModel != null)
                {
                    ...
                    selectedModel.IsActive = tsDurum.IsOn; // Durumu aktif olarak ayarla
        ...
        private void gridControl1_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (model != null)
            {
                ...
                tsDurum.IsOn = model.IsActive; // Durumu aktif olarak ayarla
