...
namespace PlusStokTakip.PresentationLayer.Admin.Modules.Tanimlar
{
    public partial class FrmMarka : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            var brandsList = _brandsManager.TGetAll()
                .Select(b => new
                {
                    b.BrandID,
                    b.BrandName,
        ...
        {
            var categories = _categoriesManager.TGetAll().Select(c => new
            {
                c.CategoryID,
                c.CategoryName
            });
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (selectedBrand != null)
                {
                    ...
                    selectedBrand.IsActive = tsDurum.IsOn;// Durumu aktif olarak ayarla
