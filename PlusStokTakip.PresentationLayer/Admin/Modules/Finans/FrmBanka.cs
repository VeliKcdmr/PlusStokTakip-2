...
namespace PlusStokTakip.PresentationLayer.Admin.Modules.Finans
{
    public partial class FrmBanka : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            var bankAccounts = _bankAccountsManager.TGetAll().Select(b => new
            {
                b.AccountID,
                b.BankName,
                b.Iban,
            ...
            var bankTransactions = _bankTransactionsManager.TGetAll().Select(b => new
            {
                b.TransactionID,
                b.AccountID,
        ...
        private void gridControl1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (transaction != null)
                {
                    ...
                    tsDurum.IsOn = transaction.IsActive;
                }
            }
            catch (Exception ex)
            {
